function [B, df] = get_beta_with_df(Y,X,lambda_list)
% Y       Tx1
% X       TxP
% lambda  Lx1
% B       PxL
...
for l=1:L_
    ...
    % Compute degrees of freedom using existing eigenvalues
    df(l)  = sum(a_matrix_eigval ./ (a_matrix_eigval + lambda_list(l)));
end
